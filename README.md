[DragTime.html](https://github.com/user-attachments/files/24911679/DragTime.html)
<!DOCTYPE html>
<html lang="ko">
<head>
<meta charset="UTF-8">
<title>DragTime</title>
...
<div class="modal" id="modal">
  <div class="modal-box">
    ...
    <textarea id="detailInput" placeholder="세부내용"></textarea><br><br>
...
document.addEventListener("pointermove", e=>{
  ...
  let e2 = Math.max(dragStartIndex, dragEndIndex);
  paintDragPreview(s, e2);
});
